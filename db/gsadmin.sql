...
CREATE INDEX IF NOT EXISTS idx_daily_plan_user
  ON daily_plan(user_regular_id);

CREATE INDEX IF NOT EXISTS idx_session_user
  ON daily_study_session(user_id);

CREATE INDEX IF NOT EXISTS idx_session_subject
  ON daily_study_session(subject_id);

CREATE INDEX IF NOT EXISTS idx_subject_plan_daily
  ON subject_plan(daily_plan_id);

CREATE INDEX IF NOT EXISTS idx_subject_plan_subject
  ON subject_plan(subject_id);

CREATE INDEX IF NOT EXISTS idx_study_type_map_type
  ON session_study_type(study_type_id);
